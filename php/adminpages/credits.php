...
?>
			<div id="postbox-container-1" class="postbox-container">
				<div class="postbox" id="taxonomies-sortable-credits">
					<h3 class="hndle"><?php /* translators: */ echo esc_html( sprintf( __( 'Taxonomies Sortable %s', 'taxonomies-sortable' ), TAXONOMIES_SORTABLES_PLUGIN_VERSION ) ); ?></h3>
					<div class="inside">
						<h4><?php esc_html_e( 'Changelog', 'taxonomies-sortable' ); ?></h4>
						<p>
							<?php esc_html_e( 'What\'s new in', 'taxonomies-sortable' ); ?>
							<a href="https://github.com/enrico-sorcinelli/taxonomies-sortable/releases"><?php /* translators: */ echo esc_html( sprintf( __( 'version %s', 'taxonomies-sortable' ), TAXONOMIES_SORTABLES_PLUGIN_VERSION ) ); ?></a>.
						</p>
